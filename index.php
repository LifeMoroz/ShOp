            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Удалить объект?</h3>
                    </div>
                    <div class="modal-body">
                        Внимание! После удалении данный объект нельзя будет восстановить!<br>
                    ...
                    <div class="modal-footer">
                        ...
                        <tr>
                            <td width="*"></td>
                            <td width="180">
                                <button type="button" id="modal_form_cancel_button" data-dismiss="modal">Отмена</button>
                            </td>
                            <td width="5"></td>
                            <td width="180">
                                <form method="post" action="" id="delete_form">
                                    <input type="hidden" name="id" value="'.$id.'">
                                    <input type="submit" value="Подтвердить удаление" name="'.$delete_button_name.'" id="modal_form_accept_button">
                                </form>
                            </td>
                        </tr>
                        </table>
        ...
        <div class="modal-content modal-recall">
			<form method="post" action="">
				...
				<div class="modal-body modal-delivery">
					...
					<label class="modal-recall_label">
						Телефон:
						<input type="text" name="phone" class="modal-recall_input"/>
					</label>
				...
				<div class="modal-footer modal-delivery">
					<input type="submit" name="add-call-me-message-button" value="Отправить" class="green_button_modal" data-dismiss="modal">
				</div>
			</form>
        </div>
    </div>
