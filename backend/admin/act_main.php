...
{
	up_admin($_POST['admin_id']);
}
else if ($_POST['down-admin-button'])
{
	down_admin($_POST['admin_id']);
}
else if ($_POST['admin-reg-button'])
{
	...
	$add_new_admin_message = register_admin($_POST['email'], $_POST['name'], $rights);
		...
		if ($_SESSION['admin']['rights'])
		{
			...
			$form = '
				<form method="post" action="">
					...
					<input type="submit" value="Удалить" name="delete-admin-button" id="button" class="mini_button">
				</form>
				';
		}
